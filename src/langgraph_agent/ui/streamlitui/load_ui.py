...
from src.langgraph_agent.ui.uiconfigfile import Config
...
class LoadStreamlitUI:
    ...
    #         "Input your requirements", height=200, key="req_input"
    #     )
    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if self.user_controls["selected_llm"] == "Groq":
                ...
                self.user_controls["selected_groq_model_option"] = st.selectbox(
                ...
                self.user_controls["GROQ_API_KEY"] = st.session_state[
                    "GROQ_API_KEY"
                ] = st.text_input("Input API Key", type="password")

                # Validate the API Key
                if not self.user_controls["GROQ_API_KEY"]:
                    st.warning("Please Create the API Key from the groq.com")
